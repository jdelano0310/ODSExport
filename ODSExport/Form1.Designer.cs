namespace ODSExport
{
    partial class frmMain
    {
        ...
        private void InitializeComponent()
        {
            ...
            cboDelimiter.Items.AddRange(new object[] { "Select file delimiter", "Comma", "Tab", "Semicolon", "Colon", "Pipe", "Forward Slash", "Back Slash" });
            cboDelimiter.Location = new Point(547, 61);
            cboDelimiter.Margin = new Padding(2, 2, 2, 2);
            cboDelimiter.Name = "cboDelimiter";
            cboDelimiter.Size = new Size(146, 23);
            cboDelimiter.TabIndex = 9;
            // 
            // frmMain
            // 
